...
app.get('/', function (req, res) {
  res.send('Welcome to the Northwest Missouri State University!  <br> <br>' +
    'Courses in Applied Computer Science First Semester'+
    '<br> <br>Web apps<br>Java<br>Database Systems<br><br>'+
